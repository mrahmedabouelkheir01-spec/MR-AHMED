window.BackupManager = {
    ...
    restoreBackup(id) {
        ...
        if (confirm('تحذير: هل أنت متأكد من رغبتك في استعادة هذه النسخة؟ سيتم حذف جميع البيانات الحالية واستبدالها.')) {
            try {
    ...
    deleteBackup(id) {
        if (confirm('هل أنت متأكد من حذف هذا السجل من قائمة النسخ الاحتياطية؟ (لن يتم حذف الملف من جهازك)')) {
